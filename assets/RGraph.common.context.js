...
RGraph.HideContext();}
RGraph.HideZoomedCanvas();RGraph.HidePalette();canvas.__object__.Set('chart.mousedown', false);var x = e.pageX;var y = e.pageY;var div = document.createElement('div');var bg = document.createElement('div');div.className = 'RGraph_contextmenu';div.__canvas__ = canvas; 
...
var canvas = arguments[0];var event = arguments[1];} else if(RGraph.Registry.Get('chart.contextmenu')){
var canvas = RGraph.Registry.Get('chart.contextmenu').__canvas__;} else {
